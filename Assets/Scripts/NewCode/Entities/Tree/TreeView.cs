...
namespace Garden
{
    public class TreeView : EntityView
    {
        ...
        public override void Init(IEntityData entityData, FieldManager manager, IPalette specialPalette, Field field, Vector2Int position)
        {
            _treePalette = (TreePalette)specialPalette;
            _treeData = (TreeData)entityData;
            base.Init(entityData, manager, specialPalette, field, position);
